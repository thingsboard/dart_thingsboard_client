...
class EventService {
  ...
  Future<PageData<Event>> getEvents(EntityId entityId, String tenantId, TimePageLink pageLink, {String? eventType, RequestConfig? requestConfig}) async {
    var url = '/api/events/${entityId.entityType.toShortString()}/${entityId.id}';
    if (eventType != null) {
      url += '/$eventType';
    }
    var queryParams = pageLink.toQueryParameters();
    queryParams['tenantId'] = tenantId;
    var response = await _tbClient.get<Map<String, dynamic>>(url, queryParameters: queryParams,
