...
PageData<DeviceProfileInfo> parseDeviceProfileInfoPageData(Map<String, dynamic> json) {
...
class DeviceProfileService {
  ...
  Future<PageData<DeviceProfile>> getDeviceProfiles(PageLink pageLink,  {RequestConfig? requestConfig}) async {
    var response = await _tbClient.get<Map<String, dynamic>>('/api/deviceProfiles', queryParameters: pageLink.toQueryParameters(),
  ...
  Future<DeviceProfile> saveDeviceProfile(DeviceProfile deviceProfile, {RequestConfig? requestConfig}) async {
    var response = await _tbClient.post<Map<String, dynamic>>('/api/deviceProfile', data: jsonEncode(deviceProfile),
        options: defaultHttpOptionsFromConfig(requestConfig));
    return DeviceProfile.fromJson(response.data!);
  }

  Future<void> deleteDeviceProfile(String deviceProfileId, {RequestConfig? requestConfig}) async {
    await _tbClient.delete('/api/deviceProfile/$deviceProfileId',
        options: defaultHttpOptionsFromConfig(requestConfig));
  }

  Future<DeviceProfile> setDefaultDeviceProfile(String deviceProfileId, {RequestConfig? requestConfig}) async {
    var response = await _tbClient.post<Map<String, dynamic>>('/api/deviceProfile/$deviceProfileId/default',
        options: defaultHttpOptionsFromConfig(requestConfig));
    return DeviceProfile.fromJson(response.data!);
  }

  Future<DeviceProfileInfo> getDefaultDeviceProfileInfo({RequestConfig? requestConfig}) async {
    var response = await _tbClient.get<Map<String, dynamic>>('/api/deviceProfileInfo/default',
        options: defaultHttpOptionsFromConfig(requestConfig));
  ...
  Future<PageData<DeviceProfileInfo>> getDeviceProfileInfos(PageLink pageLink,  {DeviceTransportType? transportType, RequestConfig? requestConfig}) async {
    ...
    var response = await _tbClient.get<Map<String, dynamic>>('/api/deviceProfileInfos', queryParameters: queryParams,
        options: defaultHttpOptionsFromConfig(requestConfig));
    return _tbClient.compute(parseDeviceProfileInfoPageData, response.data!);
  }

  Future<List<String>> getDeviceProfileDevicesAttributesKeys({String? deviceProfileId, RequestConfig? requestConfig}) async {
    var queryParams = <String, dynamic>{};
    if (deviceProfileId != null) {
      queryParams['deviceProfileId'] = deviceProfileId;
    }
    var response = await _tbClient.get<List<String>>('/api/deviceProfile/devices/keys/attributes', queryParameters: queryParams,
        options: defaultHttpOptionsFromConfig(requestConfig));
    return response.data!;
  }

  Future<List<String>> getDeviceProfileDevicesTimeseriesKeys({String? deviceProfileId, RequestConfig? requestConfig}) async {
    var queryParams = <String, dynamic>{};
    if (deviceProfileId != null) {
      queryParams['deviceProfileId'] = deviceProfileId;
    }
    var response = await _tbClient.get<List<String>>('/api/deviceProfile/devices/keys/timeseries', queryParameters: queryParams,
        options: defaultHttpOptionsFromConfig(requestConfig));
    return response.data!;
  }
