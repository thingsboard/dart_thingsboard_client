...
class RuleChain extends AdditionalInfoBased<RuleChainId> with HasName, HasTenantId {
...
class RuleChainMetaData {
  ...
  RuleChainMetaData.fromJson(Map<String, dynamic> json):
        ...
        nodes = json['nodes'] != null ? (json['nodes'] as List<dynamic>).map((e) => RuleNode.fromJson(e)).toList() : null,
        connections = json['connections'] != null ? (json['connections'] as List<dynamic>).map((e) => NodeConnectionInfo.fromJson(e)).toList() : null,
        ruleChainConnections = json['ruleChainConnections'] != null ? (json['ruleChainConnections'] as List<dynamic>).map((e) => RuleChainConnectionInfo.fromJson(e)).toList() : null;

  Map<String, dynamic> toJson() {
    var json = <String, dynamic>{
      'ruleChainId': ruleChainId.toJson()
    };
    ...
    if (ruleChainConnections != null) {
      json['ruleChainConnections'] = ruleChainConnections!.map((e) => e.toJson()).toList();
    }
    return json;
  }
...
class RuleChainData {
  ...
  RuleChainData({
    required this.ruleChains,
    required this.metadata
  });

  RuleChainData.fromJson(Map<String, dynamic> json):
        ruleChains = (json['ruleChains'] as List<dynamic>).map((e) => RuleChain.fromJson(e)).toList(),
        metadata = (json['metadata'] as List<dynamic>).map((e) => RuleChainMetaData.fromJson(e)).toList();
